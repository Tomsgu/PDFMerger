...
class PdfCollectionTest extends TestCase
{
    public function testAddPdf()
    {
        ...
        $pdfFileLandscape = new PdfFile('./tests/Data/page1.pdf', PdfFile::ALL_PAGES, PdfFile::ORIENTATION_LANDSCAPE);
        ...
        $pdfCollection->addPdf('./tests/Data/page1.pdf', PagesParser::ALL_PAGES, PdfFile::ORIENTATION_LANDSCAPE);
